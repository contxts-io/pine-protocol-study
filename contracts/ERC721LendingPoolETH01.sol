    ...
    PausableUpgradeable
{
    ...
    function borrowETH(
        ...
        _loans[nftID] = LoanTerms(
            ...
            durationSeconds_poolParam[loanDurationSeconds]
     ...
     */
    function emergencyWithdrawLoanCollateral(
        uint256 nftID,
        bytes memory signature,
        uint8 withdrawToOwner
    ) public whenPaused onlyOwner {
        require(nftHasLoan(nftID), "could be withdrawn using withdrawERC721");
        require(
            verify(
                _supportedCollection,
                nftID,
